function [tau_list, is_success, a_table, b_table, c_table] = CTHMM_compute_expected_tau_for_a_path_closedform_log(state_seq, total_dur)
...
for i = 1:n
    ...
    c_table(i) = temp;
    denumerator = denumerator + temp * exp_lamda_T(i);
end
